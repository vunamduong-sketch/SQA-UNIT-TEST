module.exports = {
  ...
  moduleNameMapper: {
    ...
    "^config/api$": "<rootDir>/tests/mocks/configApiMock.js",
    "^redux/hooks$": "<rootDir>/tests/mocks/reduxHooksMock.js",
    "^redux/slice/activitySlide$": "<rootDir>/tests/mocks/activitySlideMock.js",
    "^utils/formatCurrency$": "<rootDir>/tests/mocks/formatCurrencyMock.js",
    "^components/(.*)$": "<rootDir>/src-under-test/components/$1",
    "^swiper/react$": "<rootDir>/tests/mocks/swiperReactMock.jsx",
