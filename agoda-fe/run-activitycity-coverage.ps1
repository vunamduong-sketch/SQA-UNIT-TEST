...
node ../../SQA/agoda-fe/node_modules/jest/bin/jest.js `
  ...
  tests/components/ActivityCity `
  --runInBand `
  --coverage `
  --collectCoverageFrom="src-under-test/components/ActivityCity/*.jsx"
