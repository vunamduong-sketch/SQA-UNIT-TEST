...
node ../../SQA/agoda-fe/node_modules/jest/bin/jest.js --config jest.config.js tests/components/ActivityDetail --runInBand --coverage --collectCoverageFrom="src-under-test/components/ActivityDetail/*.jsx"
