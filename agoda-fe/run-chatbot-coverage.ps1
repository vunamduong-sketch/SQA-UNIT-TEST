...
node ../../SQA/agoda-fe/node_modules/jest/bin/jest.js `
  ...
  tests/components/Chatbot `
  --runInBand `
  --coverage `
  --collectCoverageFrom="src-under-test/components/Chatbot/*.jsx"
