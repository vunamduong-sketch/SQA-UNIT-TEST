...
node ../../SQA/agoda-fe/node_modules/jest/bin/jest.js `
  ...
  tests/components/City `
  --runInBand `
  --coverage `
  --collectCoverageFrom="src-under-test/components/City/**/*.jsx"
