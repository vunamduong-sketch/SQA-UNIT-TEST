...
node ../../SQA/agoda-fe/node_modules/jest/bin/jest.js `
  ...
  --runInBand `
  --coverage `
  --collectCoverageFrom="src-under-test/components/Favourite/*.jsx"
