...
node D:\SQA\agoda-fe\node_modules\jest\bin\jest.js `
  ...
  tests/components/Flight1 `
  --runInBand `
  --coverage `
  --collectCoverageFrom="src-under-test/components/Flight1/*.jsx"
