...
node D:\SQA\agoda-fe\node_modules\jest\bin\jest.js `
  ...
  tests/components/Hotel `
  --runInBand `
  --coverage `
  --collectCoverageFrom="src-under-test/components/Hotel/*.jsx"
