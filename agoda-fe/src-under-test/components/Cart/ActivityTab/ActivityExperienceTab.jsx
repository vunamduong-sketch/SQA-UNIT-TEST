                ...
                {new Array(15).fill(0).map((item, index) => (
                    <SwiperSlide key={index}>
                        <div className="rounded-[16px] overflow-hidden border-[1px] border-[#d5d9e2] hover:shadow-[rgba(4,7,10,0.24)_0px_4px_10px_0px] transition-all duration-200">
                            <img
                                src="https://image.kkday.com/v2/image/get/w_960,c_fit,q_55,wm_auto/s1.kkday.com/product_128283/20241218040547_y5EPU/jpg"
...
export default ActivityExperienceTab;
