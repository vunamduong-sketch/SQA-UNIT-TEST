...
// ============================================================
// TÊN FILE: activityDetailCoverageTable.js
// MÔ TẢ: Custom Jest coverage reporter cho folder ActivityDetail.
//        Reporter in tổng quan Total/Statements/Miss và bảng chi tiết
//        File | Statements | Miss | Coverage giống mẫu báo cáo.
// ============================================================

class ActivityDetailCoverageTableReporter {
  onRunComplete(_, results) {
    ...
    const componentDir = path.normalize(
      path.join(process.cwd(), "src-under-test", "components", "ActivityDetail")
    );
    ...
    if (rows.length === 0) {
      console.log("Không tìm thấy coverage cho src-under-test/components/ActivityDetail.");
      return;
    }
    ...
    console.log("\nActivityDetail Coverage Summary");
    console.table(rows);
  }
}

module.exports = ActivityDetailCoverageTableReporter;
